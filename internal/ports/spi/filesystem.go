// Package spi defines service provider interface ports for hexagonal architecture.
//
// These interfaces define contracts that infrastructure adapters must implement
// to provide services to the domain layer. This package contains the driven ports
...
// FileSystemPort provides safe file read/write/walk operations for domain services.
//
...
// All operations honor config-defined vault roots and use atomic write patterns.
