...
//!
//! [`AppDirs`] merges [`EnvVars`](crate::env::EnvVars) overrides with XDG
//! platform defaults from [`crate::env`].
//!
//! # Example
//!
//! ```rust,ignore
//! use lithos_core::{dirs::AppDirs, env::EnvVars};
//!
...
///
/// Merges [`EnvVars`](crate::env::EnvVars) overrides with XDG platform
...
impl AppDirs {
    ...
    #[inline]
    #[must_use]
    pub fn new(vars: &crate::env::EnvVars) -> Self {
        let cache = vars
            .cache_dir()
            .cloned()
