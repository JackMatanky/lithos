...
use crate::{fs::PathKey, utils::UuidV7};
...
///
/// ```
/// use lithos_core::template::TemplateId;
///
...
impl TemplateId {
    ...
    /// # Errors
    ///
    /// Returns [`crate::utils::UuidV7Error`] if parsing fails or the UUID is
    /// not v7.
    ///
    /// # Examples
    ///
...
/// use std::path::Path;
///
/// use lithos_core::template::TemplateName;
///
...
///
/// ```
/// use lithos_core::template::TemplateBody;
///
