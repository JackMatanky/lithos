...
impl TemplateEngine {
    ...
    ///
    /// This method uses the `Emitter` to convert the template metadata
    ...
    pub fn compile_from_template(
        ...
        let source = super::Emitter::emit(template);
...
mod tests {
    ...
    mod integration {
        ...
        fn multi_level_inheritance() {
            ...
            // Remove any newlines that might be emitted by the emitter
