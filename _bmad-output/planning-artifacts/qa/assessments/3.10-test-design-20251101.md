...
| ID           | Level       | Priority | Test                      | Justification            |
| ------------ | ----------- | -------- | ------------------------- | ------------------------ |
| 3.10-UNIT-009 | Unit        | P0       | QueryService PathQuery method uses full NoteID as key | Index population logic |
| 3.10-UNIT-010 | Unit        | P0       | QueryService BasenameQuery method extracts basename from NoteID | String manipulation and indexing |
