...
#### AC3: QueryService FrontmatterQuery method

**Coverage: FULL**

- **Unit Test**: `internal/app/query/service_test.go::TestQueryService_FrontmatterQuery`
  - Given: QueryService with indexed notes containing frontmatter
  - When: FrontmatterQuery() called with field and value
  - Then: Returns matching notes or empty slice

- **Unit Test**: `internal/app/query/service_test.go::TestQueryService_FrontmatterQuery_NoMatches`
  - Given: QueryService with indexed notes
  - When: FrontmatterQuery() called with non-existent field/value
