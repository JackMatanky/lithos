...
This story completes the schema-driven lookups (Epic 4) by wiring all components through dependency injection and ensuring the entire lookup workflow works correctly through e2e testing. It follows the same pattern established in story 1.16 for the foundational CLI.
