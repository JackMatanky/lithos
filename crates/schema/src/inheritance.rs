    ...
    T: rkyv::Archive,
{
    ...
    pub fn to_dag_graph(
        &self,
    ) -> Result<DagGraph<SchemaId, T>, crate::error::SchemaInheritanceError>
    where
        T: Clone + crate::GraphNode,
    {
        let mut builder = SchemaGraphBuilder::new();
...
where
    T: rkyv::Archive + Clone + crate::GraphNode,
{
    type Error = crate::error::SchemaInheritanceError;
    ...
    T: crate::GraphNode,
{
    ...
    pub fn topo_order(
        &self,
    ) -> Result<Vec<SchemaId>, crate::error::SchemaInheritanceError> {
        ...
        F: FnMut(SchemaId, T) -> Result<U, E>,
    {
        ...
        Ok(ProcessingGraph {
            inner: crate::Graph::from_parts(new_nodes, parents, children),
