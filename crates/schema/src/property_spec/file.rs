...
mod tests {
    ...
    #[case::out_dir(
        ...
        Err(SchemaError::PropertyValue(
            crate::error::FileValueValidationError::FileOutsideAllowedDirectory {
    ...
    fn file_spec_rejects_prefix_bypass() {
        ...
        assert!(matches!(
            result,
            Err(SchemaError::PropertyValue(
                crate::error::PropertyValueError::File(
                    crate::error::FileValueValidationError::FileOutsideAllowedDirectory { .. }
                )
            ))
        ));
    ...
    fn file_spec_rejects_parent_dir_traversal() {
        ...
        assert!(matches!(
            ...
            Err(SchemaError::PropertySpec(
                crate::error::PropertySpecError::File(
                    crate::error::FileSpecError::MalformedDirectoryConstraint { .. }
                )
            ))
        ));
    }
    ...
    fn file_spec_rejects_empty_file_class() {
        ...
        assert!(matches!(
            ...
            Err(SchemaError::PropertySpec(
                crate::error::PropertySpecError::File(
                    crate::error::FileSpecError::EmptyFileClassConstraint { .. }
                )
            ))
        ));
    }
