...
//! keeps orchestration in the [`Builder`](crate::Builder).
//!
//! # Design
//!
...
mod tests {
    ...
    mod run {
        use super::*;
        use crate::{bank::PropertyBank, repository::WriteRepository};
    ...
    mod comparison {
        use super::*;
        use crate::views::RawPropertyBankView;
    ...
    mod analysis {
        ...
        fn analyze_returns_corrupt_when_delta_engine_fails() {
            ...
            changed_raw.properties = crate::raw::RawPropertyMap::from_map(map);
    ...
    mod construction {
        ...
        fn update_applies_deltas_and_persists() {
            ...
            let (delta, _) = PropertyDeltaEngine::for_property_bank(
                &changed_raw,
                &crate::views::hashes::RawPropertyHashIndex::from(
        ...
        fn update_persists_hashes_from_raw_property_bank_when_changed_content_hash_matches()
         {
            ...
            let changed = PropertyBankProcessor {
                ...
                status: Changed {
                    raw: fixture.raw,
                    delta: crate::delta::PropertyDelta::default(),
                    content_hash: fixture.content_hash,
                },
                _stage: std::marker::PhantomData::<Construction>,
            };
