...
impl ReadRepository for RedbRepository {
    ...
    fn get_topological_graph(
        ...
        Option<crate::inheritance::InheritanceGraph<()>>,
    ...
    fn get_schema_index(
        &self,
    ) -> Result<crate::index::SchemaIndex, SchemaRepositoryError> {
...
mod tests {
    ...
    mod index_lookups {
        use super::*;
        use crate::storage::tables::{SCHEMA_ID_BY_NAME, SCHEMA_ID_BY_PATH};
    ...
    mod raw_views {
        ...
        fn by_path_returns_none_when_path_index_points_to_missing_view() {
            use crate::storage::tables::SCHEMA_ID_BY_PATH;
