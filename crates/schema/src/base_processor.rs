...
//! [`SchemaProcessor`](crate_processor::SchemaProcessor) for
...
use crate::{
    bank::PropertyBank,
    base::BaseSchema,
    delta::{ExcludesDelta, ExtendsDelta, PropertyDelta, PropertyDeltaEngine},
        ...
        let schema_name =
            SchemaName::try_from(file.path().basename().ok_or_else(|| {
                SchemaError::from(SchemaBuilderError::Read(
                    crate::error::SchemaReadError::InvalidFileName {
