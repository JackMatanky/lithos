...
pub enum SchemaRepositoryError {
    ...
    NotFoundById(crate::identifier::SchemaId),

    /// Returned when an expected entity is missing by name.
    #[error("schema name not found: {0}")]
    NotFoundByName(crate::identifier::SchemaName),
...
pub enum SchemaInheritanceError {
    ...
    CycleDetected {
        ...
        nodes: Vec<crate::identifier::SchemaId>,
    },
...
impl From<crate::GraphError<crate::identifier::SchemaId>>
    for SchemaInheritanceError
{
    #[inline]
    fn from(err: crate::GraphError<crate::identifier::SchemaId>) -> Self {
        match err {
            crate::GraphError::CycleDetected {
                nodes,
            } => Self::CycleDetected {
                nodes,
            },
            crate::GraphError::NotDirected => Self::NotDirected,
            crate::GraphError::MissingNode {
                id,
            } => Self::MissingNode {
                id,
            },
...
pub enum SchemaResolutionError {
    ...
    ParentNotFound {
        /// Child schema name.
        child: crate::identifier::SchemaName,
        /// Parent schema name.
        parent: crate::identifier::SchemaName,
    },
    ...
    CycleDetected {
        ...
        schemas: Vec<crate::identifier::SchemaName>,
    },
}
...
impl From<traces_fs::error::FsError> for SchemaBuilderError {
    ...
    fn from(err: traces_fs::error::FsError) -> Self {
        ...
        match err {
            ...
            other => Self::Read(SchemaReadError::FileSystem {
                reason: other.to_string(),
            }),
        }
    }
    ...
    mod formatting {
        ...
        #[case::resolution_parent_missing(
            SchemaError::from(SchemaResolutionError::ParentNotFound {
                child: crate::identifier::SchemaName::try_new("child").unwrap(),
                parent: crate::identifier::SchemaName::try_new("parent").unwrap(),
            }),
        ...
        #[case::not_found_by_id(
            SchemaRepositoryError::NotFoundById(
                crate::identifier::SchemaId::new()
            ),
            "schema not found:"
        )]
        #[case::not_found_by_name(
            SchemaRepositoryError::NotFoundByName(crate::identifier::SchemaName::try_new("test").unwrap()),
