...
mod tests {
    ...
    impl ReadRepository for CountingReadRepo {
        fn find_schema_by_id(
            &self,
            id: SchemaId,
        ) -> Result<Option<Schema>, crate::error::SchemaRepositoryError>
        {
        ...
        fn find_many_schemas_by_id(
            &self,
            ids: &[SchemaId],
        ) -> Result<Vec<Option<Schema>>, crate::error::SchemaRepositoryError>
        {
        ...
        fn find_schemas_by_ids(
            &self,
            ids: &[SchemaId],
        ) -> Result<Vec<Schema>, crate::error::SchemaRepositoryError> {
        ...
        fn find_schemas_using_properties(
            ...
            crate::error::SchemaRepositoryError,
        > {
        ...
        fn get_raw_schema_view(
            &self,
            id: SchemaId,
        ) -> Result<Option<RawSchemaView>, crate::error::SchemaRepositoryError>
        {
        ...
        fn get_property_bank(
            &self,
        ) -> Result<Option<PropertyBank>, crate::error::SchemaRepositoryError>
        {
        ...
        fn find_schema_id_by_name(
            &self,
            name: &SchemaName,
        ) -> Result<Option<SchemaId>, crate::error::SchemaRepositoryError>
        {
        ...
        fn find_schema_ids_by_paths(
            &self,
            paths: &[PathKey],
        ) -> Result<Vec<Option<SchemaId>>, crate::error::SchemaRepositoryError>
        {
        ...
        fn list_schema_name_id_pairs(
            &self,
        ) -> Result<NameIdPairs, crate::error::SchemaRepositoryError> {
            self.inner.list_schema_name_id_pairs()
        }

        fn list_schema_path_id_pairs(
            &self,
        ) -> Result<PathIdPairs, crate::error::SchemaRepositoryError> {
            self.inner.list_schema_path_id_pairs()
        }

        fn get_schema_index(
            &self,
        ) -> Result<SchemaIndex, crate::error::SchemaRepositoryError> {
        ...
        fn find_base_schema_by_id(
            &self,
            id: SchemaId,
        ) -> Result<Option<BaseSchema>, crate::error::SchemaRepositoryError>
        {
        ...
        fn find_base_schemas_by_ids(
            &self,
            ids: &[SchemaId],
        ) -> Result<Vec<BaseSchema>, crate::error::SchemaRepositoryError>
        {
