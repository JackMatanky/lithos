...
mod tests {
    ...
    mod template {
        use super::*;
        use crate::storage::testing::tests::fixtures::FailOnWrite;
        ...
        mod lookup {
            use super::*;
            use crate::storage::testing::tests::fixtures::FailOnRead;
            ...
            fn upsert_overwrites_existing() {
                ...
                let t2 = Template::new(
                    *t1.id(),
                    ...
                    .unwrap(),
                    crate::aggregate::TemplateBody::try_new("updated content")
                        .unwrap(),
                );
                repo.save_template(&t2).unwrap();
