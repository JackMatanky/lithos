...
//! 2. **Semantic ([`crate::task::Task`]):** A "promoted" entity that represents
//!    a checkbox item with validated domain logic (e.g., due dates,
//!    priorities).
...
impl InlineField {
    ...
    pub fn from_token(
        ...
        use crate::raw::value::RawFieldValue;
