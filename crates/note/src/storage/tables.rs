...
///
/// Stores full [`Note`](crate::aggregate::Note) structures indexed
/// by [`NoteId`](crate::aggregate::NoteId) for O(1) identity lookup.
/// All other note tables are secondary indexes maintained synchronously
/// during write operations.
///
/// Key: [`NoteId`](crate::aggregate::NoteId)
...
///
/// Stores cached [`ListView`](crate::views::ListView) projections for
...
///
/// Key: [`NoteId`](crate::aggregate::NoteId)
/// Value: rkyv-serialized [`ListView`](crate::views::ListView)
///
/// # Cache Semantics
///
