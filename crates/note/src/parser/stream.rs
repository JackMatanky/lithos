...
use crate::{error::NoteIngestError, position::SourceByteRange};
...
mod tests {
    ...
    use super::*;
    use crate::position::SourceByteOffset;
    ...
    mod event_adapter_iter_math_contract {
        use super::*;
        use crate::parser::types::MathKind;
    ...
    mod event_adapter_iter_extension_support {
        ...
        fn reject_policy_returns_error_for_unknown_block_extensions() {
            let config = EventStreamConfig::with_policy(
                crate::parser::config::ExtensionsPolicy::new(
                    crate::parser::config::ExtensionFlags::EMPTY,
                    crate::parser::config::MetadataPolicy::None,
                ),
                crate::parser::config::EventRetentionPolicy::new(
                    crate::parser::config::UnknownEventPolicy::Reject,
                    crate::parser::config::UnknownEventPolicy::Drop,
                ),
                BreakPolicy::NormalizeAsText,
                true,
            );
        ...
        fn policy_fail_on_unsupported() {
            ...
            assert!(matches!(
                err,
                NoteIngestError::Domain(crate::error::NoteError::Parse(
                    crate::error::NoteParseError::PolicyViolation {
