...
/// };
/// let link =
///     Link::try_new_wikilink(target, None, None, SourceByteOffset::new(0))?;
///
...
mod tests {
    mod fixtures {
        ...
        use crate::{error::NoteError, position::SourceByteOffset};
    ...
    mod constructors {
        ...
        fn new_wikilink_rejects_empty_target() {
            ...
            let result = Link::try_new_wikilink(
                ...
                None,
                None,
                crate::position::SourceByteOffset::new(0u32),
            );
            result.unwrap_err();
        }
