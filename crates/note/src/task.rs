...
impl TaskDates {
    ...
    fn match_date_spec(
        spec: &TaskConfigSpec,
        keyword: &str,
    ) -> Option<(TaskDateKind, Arc<traces_settings::value::DateSpec>)> {
        use traces_settings::task::TemporalSlot;
...
pub struct TaskDateValue {
    value: FieldValue,
    spec: Option<Arc<traces_settings::value::DateSpec>>,
}
...
impl TaskDateValue {
    ...
    #[inline]
    #[must_use]
    pub fn spec(&self) -> Option<&traces_settings::value::DateSpec> {
        self.spec.as_deref()
    }
