...
mod tests {
    ...
    use trace_discovery::report::DiscoveryReport;
    ...
    fn placeholder_cache_root() -> trace_discovery::location::CacheRoot {
        trace_discovery::location::CacheRoot::new(
            trace_discovery::location::CacheLocation::Global(
                trace_discovery::location::GlobalCacheLocation::PlatformUserCache,
            ),
    ...
    mod from_discovery {
        use super::*;
        use crate::repository::ReadRepository as _;
