---
title: 23_11_07_document_code_snippets_used_in_taboola_assignment
uuid: f588e6a2-34f5-4bfc-9d1b-7b0d4e8b175e
aliases:
  - Document Code Snippets Used in Taboola Assignment
  - 23-11-07 Document Code Snippets Used in Taboola Assignment
  - document code snippets used in taboola assignment
  - document_code_snippets_used_in_taboola_assignment
  - 23_11_07_document_code_snippets_used_in_taboola_assignment
date: "[[2023-11-07]]"
due_do: do
pillar:
...
>
> | [[23_11_07_document_code_snippets_used_in_taboola_assignment#Tasks and Events\|Tasks]] | [[23_11_07_document_code_snippets_used_in_taboola_assignment#Prepare and Reflect\|Insight]] | [[23_11_07_document_code_snippets_used_in_taboola_assignment#Related Tasks and Events\|Related Tasks]] | [[23_11_07_document_code_snippets_used_in_taboola_assignment#Related Knowledge\|PKM]] | [[23_11_07_document_code_snippets_used_in_taboola_assignment#Related Library Content\|Library]] |
> |:--------: |:--------: |:--------: |:--------: |:--------: |

- [x] #task Document Code Snippets Used in Taboola Assignment_action_item [time_start:: 09:45]  [time_end:: 11:30]  [duration_est:: 60] ⏰ 2023-11-07 09:40 ➕ 2023-11-07 📅 2023-11-07 ✅ 2023-11-07
...
>     - **Problem**:: I used old and wrote new formulas and expressions for my Taboola assignment and am afraid that I might forget or lose them if I do not document them.
>
> 2. What do I want?
>     - **Desire**:: I want to save the formulas and expressions I write in an organized manner to easily reference at a later point.
>
> 3. What will I do?
>     - **Plan**:: I will update the code snippet template to choose function links in the info section and then review the google sheets and tableau files from the assignment.
>
> 4. What don't I do while performing the task?
>     - **Refrain**:: I do not work on other templates and I do not take cigarette breaks.
...
>     - **Outcome**:: I was not focused and wasted time on procrastination tasks for around thirty minutes. Once I stopped myself, I updated the snippet file, which took me longer than expected and, then, created on snippet file, which also took longer than I expected.
>     - **Feeling**:: I am a bit upset at myself for procrastinating for thirty minutes.
>
> 2. What went well?
>     - **Keep**::
>
