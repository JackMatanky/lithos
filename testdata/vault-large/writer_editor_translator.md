---
title: writer_editor_translator
uuid: 6f6c7683-1571-44c4-a028-9321024dc28f
aliases:
...
WHERE
	((file.frontmatter.pillar) = "writer_editor_translator")
...
WHERE any(file.frontmatter.pillar = "writer_editor_translator")
