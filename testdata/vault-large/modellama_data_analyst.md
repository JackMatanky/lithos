---
title: modellama_data_analyst
uuid: 6e55e94d-9421-479f-8ce5-e1963bb34ea8
aliases:
  - Data Analyst at Modellama
  - data analyst at modellama
  - Data_Analyst_at_Modellama
  - modellama_data_analyst
task_start: "[[2025-06-18]]"
task_end: "[[2025-06-22]]"
due_do: do
pillar:
...
organization:
  - "[[modellama|Modellama]]"
contact:
  - "[[jacalne_joanna_marie|Joanna Marie Jacalne]]"
library:
status: rejected
type: job_application
file_class: task_parent
date_created: 2025-06-18T14:49
date_modified: 2025-06-25T14:54
tags:
---
# Data Analyst at Modellama
...
>
> | [[modellama_data_analyst#Prepare and Reflect\|Insight]] | [[modellama_data_analyst#Tasks and Events\|Tasks and Events]] | [[modellama_data_analyst#Related Tasks and Events\|Related Tasks]] |
> |:--------: |:--------: |:--------: |
> | [[modellama_data_analyst#Related Knowledge\|PKM]] | [[modellama_data_analyst#Related Library Content\|Library]] | [[modellama_data_analyst#Related Directory\|Directory]] |
...
> [!info] Job Application Details
>
> Job Title:: [[data_analyst|Data Analyst]]
> City:: Ra'anana
> Work Model:: On-site
>
> Link:: [Data Analyst at Modellama (LinkedIn)](https://www.linkedin.com/jobs/view/4141497097/)

🚀 We're Hiring: Data Analyst – On-Site in Raanana! 🚀

Modellama, a leader in predictive technology, is looking for a Data Analyst to join our team in Raanana! If you have a passion for data, love solving complex problems, and want to work on cutting-edge predictive models, we want to hear from you!

What You'll Do:
🔹 Analyze large datasets to extract insights and enhance predictive models

🔹 Use SQL, Python, or R to process and analyze data

🔹 Collaborate with data scientists and developers to refine our proprietary systems

🔹 Communicate findings clearly to drive data-driven decision

sWhat We're Looking For:

✔️ Strong analytical skills and experience in data modeling

✔️ Proficiency in SQL and at least one programming language (Python, R)

✔️ A degree in Data Science, Statistics, Mathematics, Computer Science, or a related field

✔️ Experience in predictive modeling or sports analytics is a plus!

Why Join Modellama?

🚀 Work with a passionate team of data analysts, developers, and sports enthusiasts

🎯 Be at the forefront of predictive technology

🏆 Make a real impact with industry-leading models
