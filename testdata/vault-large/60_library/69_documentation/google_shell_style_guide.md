---
title: google_shell_style_guide
uuid:
aliases:
  - Google Shell Style Guide
  - google shell style guide
  - google_shell_style_guide
main_title: "Google Shell Style Guide"
subtitle:
author:
editor:
date_published:
...
about: "Style guides for Google-originated open-source projects"
status: resource
type: documentation
file_class: lib_documentation
cssclasses:
date_created: 2025-09-28T18:32
...
| Section                                                                                                                  | Contents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Background](https://google.github.io/styleguide/#s1-background)                                                         | [Which Shell to Use](https://google.github.io/styleguide/#s1.1-which-shell-to-use) - [When to use Shell](https://google.github.io/styleguide/#s1.2-when-to-use-shell)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [Shell Files and Interpreter Invocation](https://google.github.io/styleguide/#s2-shell-files-and-interpreter-invocation) | [File Extensions](https://google.github.io/styleguide/#s2.1-file-extensions) - [SUID/SGID](https://google.github.io/styleguide/#s2.2-suid-sgid)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [Environment](https://google.github.io/styleguide/#s3-environment)                                                       | [STDOUT vs STDERR](https://google.github.io/styleguide/#s3.1-stdout-vs-stderr)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [Comments](https://google.github.io/styleguide/#s4-comments)                                                             | [File Header](https://google.github.io/styleguide/#s4.1-file-header) - [Function Comments](https://google.github.io/styleguide/#s4.2-function-comments) - [Implementation Comments](https://google.github.io/styleguide/#s4.3-implementation-comments) - [TODO Comments](https://google.github.io/styleguide/#s4.4-todo-comments)                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [Formatting](https://google.github.io/styleguide/#s5-formatting)                                                         | [Indentation](https://google.github.io/styleguide/#s5.1-indentation) - [Line Length and Long Strings](https://google.github.io/styleguide/#s5.2-line-length-and-long-strings) - [Pipelines](https://google.github.io/styleguide/#s5.3-pipelines) - [Control Flow](https://google.github.io/styleguide/#s5.4-control-flow) - [Case statement](https://google.github.io/styleguide/#s5.5-case-statement) - [Variable expansion](https://google.github.io/styleguide/#s5.6-variable-expansion) - [Quoting](https://google.github.io/styleguide/#s5.7-quoting)                                                                                                                                                                                                                        |
| [Features and Bugs](https://google.github.io/styleguide/#s6-features-and-bugs)                                           | [ShellCheck](https://google.github.io/styleguide/#s6.1-shellcheck) - [Command Substitution](https://google.github.io/styleguide/#s6.2-command-substitution) - [Test, `[…]`, and `[[… ]]`](https://google.github.io/styleguide/#s6.3-tests) - [Testing Strings](https://google.github.io/styleguide/#s6.4-testing-strings) - [Wildcard Expansion of Filenames](https://google.github.io/styleguide/#s6.5-wildcard-expansion-of-filenames) - [Eval](https://google.github.io/styleguide/#s6.6-eval) - [Arrays](https://google.github.io/styleguide/#s6.7-arrays) - [Pipes to While](https://google.github.io/styleguide/#s6.8-pipes-to-while) - [Arithmetic](https://google.github.io/styleguide/#s6.9-arithmetic) - [Aliases](https://google.github.io/styleguide/#s6.10-aliases) |
| [Naming Conventions](https://google.github.io/styleguide/#s7-naming-conventions)                                         | [Function Names](https://google.github.io/styleguide/#s7.1-function-names) - [Variable Names](https://google.github.io/styleguide/#s7.2-variable-names) - [Constants and Environment Variable Names](https://google.github.io/styleguide/#s7.3-constants-and-environment-variable-names) - [Source Filenames](https://google.github.io/styleguide/#s7.4-source-filenames) - [Use Local Variables](https://google.github.io/styleguide/#s7.5-use-local-variables) - [Function Location](https://google.github.io/styleguide/#s7.6-function-location) - [main](https://google.github.io/styleguide/#s7.7-main)                                                                                                                                                                      |
| [Calling Commands](https://google.github.io/styleguide/#s8-calling-commands)                                             | [Checking Return Values](https://google.github.io/styleguide/#s8.1-checking-return-values) - [Builtin Commands vs. External Commands](https://google.github.io/styleguide/#s8.2-builtin-commands-vs-external-commands)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [When in Doubt: Be Consistent](https://google.github.io/styleguide/#s9-conclusion)                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
- Quote variables, see [Quoting section below](https://google.github.io/styleguide/#quoting).
...
- Use arrays for safe quoting of lists of elements, especially command-line flags. See [Arrays](https://google.github.io/styleguide/#arrays) below.
...
- Be aware of the quoting rules for pattern matches in `[[ … ]]`. See the [Test, `[ …]`, and `[[ … ]]`](https://google.github.io/styleguide/#tests) section below.
...
Bash arrays should be used to store lists of elements, to avoid quoting complications. This particularly applies to argument lists. Arrays should not be used to facilitate more complex data structures (see [When to use Shell](https://google.github.io/styleguide/#when-to-use-shell) above).
...
`<` and `>` don't perform numerical comparison inside `[[ … ]]` expressions (they perform lexicographical comparisons instead; see [Testing Strings](https://google.github.io/styleguide/#testing-strings)). For preference, don't use `[[ … ]]` *at all* for numeric comparisons, use `((…))` instead.
