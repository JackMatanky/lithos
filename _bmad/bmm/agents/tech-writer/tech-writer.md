...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="RD or fuzzy match on rustdoc" workflow="{project-root}/_bmad/bmm/workflows/rustdoc-generation/workflow.md">[RD] Rustdoc: Generate RFC 1574 compliant rustdoc comments for Rust code (crates, modules, structs, enums, functions, traits)</item>
