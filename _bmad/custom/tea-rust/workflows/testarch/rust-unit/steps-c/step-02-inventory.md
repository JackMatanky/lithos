...
## STEP GOAL:
List all public components and map existing coverage gaps.

## MANDATORY SEQUENCE
1. List public functions/types
2. Identify existing tests
3. Map missing coverage
4. Flag risk hotspots (validation constructors, zero-copy boundaries, ports)
5. Record in output
