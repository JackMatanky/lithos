...
**Rationale:** QueryService provides efficient lookups for indexed notes. Tests use fakes for CacheReaderPort and Logger. Coverage verifies index population, query methods, cache refresh, concurrent access, and error handling. FrontmatterQuery testing deferred to Story 3.8.
...
| ID           | Level | Priority | Test Description                                                     | Justification                                         |
| ------------ | ----- | -------- | -------------------------------------------------------------------- | ----------------------------------------------------- |
| 3.6-UNIT-004 | Unit  | P0       | IDQuery returns correct Note for valid ID                               | Core lookup functionality                             |
| 3.6-UNIT-005 | Unit  | P0       | PathQuery returns correct Note for valid path                           | Path-based lookup                                     |
| 3.6-UNIT-006 | Unit  | P0       | FileClassQuery returns slice of Notes for valid file class              | Schema-based lookup                                   |
