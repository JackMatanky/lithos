...
### AC1: PathQuery and BasenameQuery query methods return correct results for all note lookups
...
| 3.13-INT-001  | Integration | P0       | PathQuery query with populated index | Service-cache interaction |
| 3.13-INT-002  | Integration | P0       | BasenameQuery query with populated index | Service-cache interaction |
| 3.13-INT-003  | Integration | P0       | PathQuery query with complex vault paths | Multi-level path handling |
| 3.13-INT-004  | Integration | P0       | BasenameQuery query with extension handling | Filename parsing edge cases |
