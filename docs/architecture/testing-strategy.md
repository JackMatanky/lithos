...
- **Performance Tests:**
  ...
  - **Load testing:** Comprehensive k6-based load testing with SLO/SLA validation
  - **Performance regression detection:** Automated benchmarks with baseline comparison
  - **Synthetic vault generation:** Generate test vaults from 250 to 100,000+ notes
...
#### Mise Tasks for Performance Testing
**Location**: `mise.toml`
...
mise run perf-profile-all     # All profiles
...
#### Typical Performance Testing Workflow

```bash
# 1. See what's available
mise run perf-dashboard

# 2. Run first performance test (10k notes)
mise run perf-test

# 3. Generate profiles for detailed analysis
...
# 6. Make optimizations and compare
