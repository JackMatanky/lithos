...
- [Lithos Architecture Document](#table-of-contents)
  ...
  - [Components](./components.md)
    ...
    - [Domain Services](./components.md#domain-services)
      - [TemplateEngineService](./components.md#templateengineservice)
      - [SchemaRegistryService](./components.md#schemaregistryservice)
      - [SchemaValidatorService](./components.md#schemavalidatorservice)
      - [VaultIndexingService](./components.md#vaultindexingservice)
    ...
    - [API Port Interfaces](./components.md#api-port-interfaces)
      - [CommandServicePort](./components.md#commandserviceport)
