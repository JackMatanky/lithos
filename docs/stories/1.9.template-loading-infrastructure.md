...
- [ ] Task 1: Implement FileMetadata model (AC: 1.9.1-1.9.2)
  - [ ] RED: Write failing test for NewFileMetadata constructor
    - [ ] Write test case in `internal/adapters/spi/file_metadata_test.go`
  ...
  - [ ] GREEN: Implement FileMetadata model
    - [ ] Create `internal/adapters/spi/file_metadata.go`
...
- [ ] Task 7: Commit changes (AC: 1.9.12)
  ...
  - [ ] Stage files:
    - [ ] `git add internal/adapters/spi/file_metadata.go`
    - [ ] `git add internal/adapters/spi/file_metadata_test.go`
