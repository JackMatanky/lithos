...
- Added normalizeFrontmatterValue function for type-agnostic frontmatter queries (int 2 matches float 2.0)
...
- High cyclomatic complexity in normalizeFrontmatterValue function (justified with nolint)
...
- [ ] Consider refactoring normalizeFrontmatterValue to reduce complexity
