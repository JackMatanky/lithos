...
1. PathQuery and BasenameQuery query methods return correct results for all note lookups
...
- Updated FrontmatterQuery method to try both direct and normalized value lookups
...
- Added TestQueryService_FrontmatterQuery_TypeNormalization test for AC4 coverage
