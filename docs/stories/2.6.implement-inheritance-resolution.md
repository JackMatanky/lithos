...
- [ ] Task 1: Implement inheritance resolution builder (AC: 2.6.1, 2.6.6)
  ...
  - [ ] Ensure the builder consumes domain `Schema` instances supplied by SchemaRegistry without performing JSON parsing.
...
- [ ] Task 4: Integrate with SchemaRegistry (AC: 2.6.7, 2.6.8)
  ...
  - [ ] Integrate inheritance resolver with SchemaRegistry.LoadSchemas() method
...
- [ ] Unit tests pass with ≥85% coverage for all inheritance scenarios including edge cases
