...
- [x] Task 1: Implement inheritance resolution builder (AC: 2.6.1, 2.6.6)
  - [x] Create `internal/adapters/spi/schema/inheritance_resolver.go` with builder pattern
...
- [x] Task 5: Add comprehensive testing (AC: 2.6.9, 2.6.10)
  - [x] Create `internal/adapters/spi/schema/inheritance_resolver_test.go` with unit tests
...
**Files Created:**
- `internal/adapters/spi/schema/inheritance_resolver.go` - InheritanceResolver with builder pattern
- `internal/adapters/spi/schema/inheritance_resolver_test.go` - Comprehensive test suite
