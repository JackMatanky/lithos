...
- [ ] Task 1: Define CLIPort interface (AC: 1.11.1)
  ...
  - [ ] Reference architecture components.md#api-port-interfaces
  - [ ] Verify interface compiles
  - [ ] Follow Port Interface Documentation Standards (see Dev Notes)
  - [ ] Linting checkpoint:
...
- [ ] Task 3: Run quality gates (AC: 1.11.3)
  ...
  - [ ] Verify no framework dependencies imported
  - [ ] Verify interfaces compile without errors
  - [ ] Linting checkpoint:
    - [ ] Final sweep: `golangci-lint run --fix internal/ports/api`
    - [ ] Verify ALL warnings resolved
    - [ ] Verify zero linting warnings

- [ ] Task 4: Commit changes (AC: 1.11.4)
  - [ ] Review all changes for completeness
  - [ ] Verify documentation quality and clarity
  - [ ] Stage files:
    - [ ] `git add internal/ports/api/cli.go`
