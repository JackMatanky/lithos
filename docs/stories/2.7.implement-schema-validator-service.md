...
- [ ] Task 1.5: Extract validation methods from domain models (AC: 2.7.5)
...
- **ARCHITECTURAL**: This story will perform major refactoring - extracting validation methods from domain models to application layer service
...
- **ARCHITECTURAL**: Plan for significant refactoring - validation methods will be moved from domain models to service layer
- Consider implementing validation extraction incrementally to minimize risk
