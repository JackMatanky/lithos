...
- [x] Task 2: Implement basic file path validation (AC: 4.2.2-4.2.4)
  ...
  - [ ] RED: Write failing test for path normalization
    ...
    - [ ] Run `go test ./internal/app/frontmatter` and confirm failure
  - [ ] GREEN: Implement minimal code to pass tests
    - [ ] Implement validateFileReference() delegating to QueryService.PathQuery
...
- ✅ Implemented FrontmatterService.Validate() method with schema + FileSpec validation
...
- ✅ Implemented path normalization (trailing slash removal)
