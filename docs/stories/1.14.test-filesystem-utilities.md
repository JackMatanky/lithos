...
- Story 1.15 delivers snake_case fixture names and removes legacy `testdata/schema` duplication.
...
- [ ] Task 1: Scaffold workspace helper (AC: 1.14.1)
...
- [ ] Task 2: Guard workspace boundaries (AC: 1.14.1)
...
- [ ] Task 3: Add fixture copy helper (AC: 1.14.2)
...
- [ ] Task 4: Unit-test workspace utilities (AC: 1.14.4)
...
- [ ] Task 5: Refactor e2e tests (AC: 1.14.3)
...
- [ ] Task 6: Refactor integration tests (AC: 1.14.3)
...
- [ ] Task 7: Remove legacy copy helpers (AC: 1.14.3)
...
- [ ] Task 8: Update testing documentation (AC: 1.14.5)
  - [ ] Add a section to `tests/README.md` describing `tempfs.Workspace` usage and cleanup guarantees.

- [ ] Task 9: Execute validations and record evidence (AC: 1.14.6)
