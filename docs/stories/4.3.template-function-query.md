...
- [ ] Task 1: Implement FileSpec detection in validation (AC: 4.2.1)
...
- [ ] Task 2: Implement basic file path validation (AC: 4.2.2-4.2.4)
...
- [ ] Task 3: Implement wikilink support (AC: 4.2.5-4.2.8)
...
- [ ] Task 4: Implement ValidationError format (AC: 4.2.9-4.2.10)
...
- [ ] Task 5: Run quality gates (AC: 4.2.12-4.2.13)
...
- [ ] Task 6: Commit changes (AC: 4.2.14)
  - [ ] Review all changes
