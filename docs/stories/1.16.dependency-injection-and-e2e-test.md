...
- [x] Task 2: Implement main.go Layers 2-5 (AC: 1.16.3-1.16.6)
  ...
  - [ ] Layer 5: Create CommandOrchestrator: `app.NewCommandOrchestrator(cliAdapter, templateEngine, schemaEngine, vaultIndexer, vaultWriter, cfg, log)`
...
- [x] Task 4: Create e2e test infrastructure (AC: 1.16.9)
  ...
  - [ ] Implement command execution: `exec.Command({tempDir}/lithos, "new", "static_template")`
...
- [x] Task 5: Add additional e2e test scenarios (AC: 1.16.10)
  - [ ] Test: `lithos new basic_note` creates note with functions
...
- [x] Task 6: Manual testing (AC: 1.16.11)
  ...
  - [ ] Note creation: `./bin/lithos new static_template` creates file
  - [ ] View flag: `./bin/lithos new static_template --view` displays content
...
func main() {
    ...
    vaultIndexer := app.NewVaultIndexer(/* vaultScanner */, /* cacheWriter */, /* cacheReader */, /* frontmatterService */, schemaEngine, cfg, log)
    vaultWriter := vault.NewVaultWriterAdapter(cfg, log)
...
func TestLithosNew_StaticTemplate(t *testing.T) {
    ...
    // Copy test template
    srcTemplate := filepath.Join("testdata", "templates", "static_template.md")
    dstTemplate := filepath.Join(templatesDir, "static_template.md")
...
- `/Users/jack/Documents/41_personal/lithos/testdata/templates/static_template.md`
- `/Users/jack/Documents/41_personal/lithos/testdata/templates/basic_note.md`
...
- ✅ `lithos new static_template` creates note with rendered content
- ✅ `lithos new basic_note` executes template functions (now, toLower, toUpper)
