...
- [ ] Task 1: Define SchemaRegistry interface and service (AC: 2.5.1, 2.5.6)
  ...
  - [ ] Ensure service operates on domain Schema objects from SchemaEnginePort (no JSON parsing)

- [ ] Task 2: Implement schema loading functionality (AC: 2.5.2, 2.5.5, 2.5.8)
  - [ ] Implement LoadSchemas method using SchemaEnginePort.LoadSchemas() and LoadPropertyBank()
  ...
  - [ ] Consume domain Schema and PropertyBank objects from SchemaEnginePort (Story 2.4)
...
- [ ] Task 5: Add comprehensive testing (AC: 2.5.9, 2.5.10)
  ...
  - [ ] Add tests with mocked SchemaEnginePort and ConfigPort dependencies using test doubles
...
- Story dependencies: Requires completion of Stories 2.3 and 2.4 for domain objects and SchemaEnginePort
...
- Story 2.4: SchemaEnginePort implementation for schema loading
