...
- [ ] Task 1: Create PropertyBank model (AC: 2.3.1-2.3.3)
...
- [ ] Task 6: Write unit tests (AC: 2.3.11, 2.3.13)
  - [ ] Create `internal/domain/property_bank_test.go`
  - [ ] Test constructor with valid property bank
  - [ ] Test constructor with empty property ID
  - [ ] Test constructor with invalid property
  - [ ] Test Lookup() success path
  - [ ] Test Lookup() not found path
  - [ ] Test Lookup() returns copy (immutability)
  - [ ] Test JSON unmarshalling from fixture

- [ ] Task 7: Run linting and tests (AC: 2.3.14-2.3.15)
  - [ ] Run golangci-lint and fix any issues
  - [ ] Run tests and verify all pass
  - [ ] Verify test coverage is comprehensive

- [ ] Task 8: Commit changes (AC: 2.3.16)
