...
- [x] Task 1: Implement QueryService struct with in-memory indices (AC: 1)
...
- [x] Task 7: Commit changes (AC: committed)
  - [x] Review all changes for completeness
  - [x] Stage files:
    - [x] `git add internal/app/query/service.go`
    - [x] `git add internal/app/query/service_test.go`
  - [x] Commit with message: `feat(query): implement QueryService with thread-safe in-memory indices`
