...
//-------------------------------------------------------------------
const date_start = moment().startOf(type).format("YYYY-MM-DD");
const date_end = moment().endOf(type).format("YYYY-MM-DD");
const year = moment().format("YYYY");
const prev_date = moment().subtract(1, moment_type).format("YYYY");
const next_date = moment().add(1, moment_type).format("YYYY");
