...
/*                     FILE TYPE AND CLASS                    */
/* ---------------------------------------------------------- */
const type_name = 'Question';
const type_value = type_name.toLowerCase();
const type_value_short = 'ques';
...
//-------------------------------------------------------------------
const context_prompt = `What is the question's context?(Title:${space}${title})`;
const about_context = await tp.system.prompt(context_prompt, null, false, true);

const question_prompt = `What is the question?(Context:${space}${about_context})`;
...
const category_yaml = tree_name_link.split(';')[1];
const branch_yaml = tree_name_link.split(';')[2];
const field_yaml = tree_name_link.split(';')[3];
const subject_yaml = tree_name_link.split(';')[4];
const topic_yaml = tree_name_link.split(';')[5];
const subtopic_yaml = tree_name_link.split(';')[6];
