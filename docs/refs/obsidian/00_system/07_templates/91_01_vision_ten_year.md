...
//-------------------------------------------------------------------
const full_type_name = "Ten Year Vision";
...
/* ---------------------------------------------------------- */
const directory = vis_ten_yr_dir;
...
> [!question] Prompt
> 
> Write in the present tense as if it is ten years in the future.
>  
> Where do I want to be and how do I want to feel in ten years?
