...
/*                     FILE TYPE AND CLASS                    */
/* ---------------------------------------------------------- */
const type_name = "Evidence";
const type_value = type_name.toLowerCase();
const type_value_short = "evid";
...
const question_link = link_alias(question_value, question_name_full);

const question_name_short =
  question_value != 'null' ? await metadata_alias(question_value) : 'null';
...
/*                       SET DESCRIPTION                      */
/* ---------------------------------------------------------- */
const about_prompt = `What is the evidence?${two_new_line}Title:${space}${title}${two_new_line}(If multiple, enumerate and use shift+enter for new line)`;
