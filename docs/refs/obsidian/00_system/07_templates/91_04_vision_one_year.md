...
//-------------------------------------------------------------------
const full_type_name = "One Year Vision";
...
/* ---------------------------------------------------------- */
const directory = vis_one_yr_dir;
...
> [!question] Prompt
> 
> Write in the present tense as if it is one year in the future.
> 
> Where do I want to be and how do I want to feel in one year?
