...
//-------------------------------------------------------------------
const full_type_name = "Detachment Journal";
...
const full_title_value = `${date}_${full_type_value}`;
const short_title_value = `${date}_${type_value}`;

const alias_arr = [full_type_name, type_name, full_title_name, short_title_name, full_title_value, short_title_value];
let file_alias = "";
