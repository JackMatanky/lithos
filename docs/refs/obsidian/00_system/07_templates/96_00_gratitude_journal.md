...
//-------------------------------------------------------------------
// CHOOSE THE JOURNAL WRITING DATE AND PREVIOUS DATE
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
const full_type_name = "Gratitude Journal";
...
const alias_arr = yaml_li(full_type_name}"${ul_yaml}"${type_name}"${new_line}${ul_yaml}"${short_title_name}"${ul_yaml}"${full_title_value}"${new_line}${ul_yaml}"${short_title_value}"${ul_yaml}"${alias);
