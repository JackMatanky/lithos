...
//-------------------------------------------------------------------
// SET SUMMARIZED LIBRARY CONTENT
//-------------------------------------------------------------------
...
const lib_resource_value = lib_obj.value;
const lib_resource_name = lib_obj.key;
const lib_resource_yaml = yaml_li_link(lib_resource_value, lib_resource_name);
