...
// SET QUOTE
//-------------------------------------------------------------------
const quote = await tp.system.clipboard();

/* ---------------------------------------------------------- */
/*                       SET DESCRIPTION                      */
/* ---------------------------------------------------------- */
const about_context = await tp.system.prompt(
  `Explain the ${type_value} in context?${two_new_line}Quote:${space}${quote}`,
  null,
  false,
  true
);
const about_general = await tp.system.prompt(
  `Explain the ${type_value} in simple terms without jargon?${two_new_line}Quote:${space}${quote}?`,
  null,
  false,
  true
);
const about = `**Quote**:${space}${quote}${two_new_line}**Contextual${space}Explanation**:${space}${about_context}${two_new_line}**General${space}Explanation**:${space}${about_general}`;
