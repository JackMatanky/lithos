...
/*                     FILE TYPE AND CLASS                    */
/* ---------------------------------------------------------- */
const type_name = "Concept";
const type_value = type_name.toLowerCase();
const type_value_short = "cnpt";
const file_class = "pkm_info";
...
/*                       SET DESCRIPTION                      */
/* ---------------------------------------------------------- */
const about_describe = await tp.system.prompt(
  `Describe the ${type_value}?${two_new_line}Concept:${space}${title}`,
  null,
  false,
  true
);
const about_explain = await tp.system.prompt(
  `Explain the ${type_value} in simple terms?${two_new_line}Concept:${space}${title}${new_line}Description:${space}${about_describe}?`,
  null,
  false,
  true
);
const about = `**Description**:${space}${about_describe}${two_new_line}**Explanation**:${space}${about_explain}`;
