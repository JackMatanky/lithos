...
//-------------------------------------------------------------------
const full_type_name = "Limiting Belief Journal";
...
const type_value = `${full_type_value.split("_")[0]}_${
  full_type_value.split("_")[1]
}`;
// const subtype_name = full_type_name.split(" ")[1];
// const subtype_value = full_type_value.split("_")[1];
const file_class = `pdev_${type_value}`;
...
let title;
if (!has_title) {
  title = await tp.system.prompt(`${type_name}?`, null, true, false);
} else {
  title = tp.file.title;
}
title = title.trim();
...
const alias_arr = [title_case, full_title_name, short_title_name, short_title_value, full_title_value];
let file_alias = "";
...
/* ---------------------------------------------------------- */
const directory = limiting_beliefs_dir;
...
## <%* tR += title_case %> Limiting Belief

> [!insight] What is the belief?

- **Belief**::

> [!insight] Does this belief create a binary, black-and-white perspective of reality?

- **Perspective**::

> [!insight] How does this belief affect my life? Does it empower me or hold me back?

- **Effect**::

> [!insight] What is the cost of maintaining this belief?

- **Cost**::

> [!insight] How did I develop this belief? What is its background and/or rationale?

- **Background**::

> [!insight] How can I reframe or negate this belief? Can I absolutely prove this (limiting) belief is true?

- **Reframe**::

> [!insight] What is an empowering affirmation, or liberating truth, to combat this belief?

- **Affirmation**::

> [!insight] How can I solidify this liberating truth in my life?
