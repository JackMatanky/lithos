...
aliases:
  ...
  - buttons
  - obsidian_buttons
  - obsidian_plugin_community_buttons
application: buttons
url: https://github.com/shabegom/buttons
file_class: lib_documentation
date_created: 2023-03-07T07:32
date_modified: 2023-10-25T16:22
tags: obsidian, obsidian/plugin, obsidian/buttons
---
# Obsidian Buttons
...
The button-block-id is a block-id placed directly below a Button codeblock and starts with `button`, e.g. `^button-id`. Button-block-ids can be used to:
