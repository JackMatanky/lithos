---
title: 32_04_next_week_day_files
aliases:
  - Next Week Calendar Day Files
  - Calendar Next Week Day Files
  - Next Week Day Files
  - next week day files
plugin: templater
language:
...
const next_week_days = "31_days_of_next_week";

//---------------------------------------------------------
// WEEKDAY CALENDAR FILES
//---------------------------------------------------------
// Retrieve the Weekday Calendar Files template and content
template = await tp.file.find_tfile(next_week_days);
...
1. [[32_03_next_week_days|Next Week and Weekdays Calendar Template]]
