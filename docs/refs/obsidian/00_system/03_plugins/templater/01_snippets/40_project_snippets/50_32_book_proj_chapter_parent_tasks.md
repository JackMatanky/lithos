---
title: 50_32_book_proj_chapter_parent_tasks
aliases:
  - Book Project Chapter Parent Tasks
  - book project chapter parent tasks
  - book proj chapter parent tasks
plugin: templater
language:
  - javascript
module:
...
const book_chapter_parent_tasks = "40_22_proj_book_chapter_parent_tasks";

//---------------------------------------------------------
// BOOK CHAPTER PARENT TASKS
//---------------------------------------------------------
// Retrieve the Book Project Chapter Parent Tasks template and content
template = await tp.file.find_tfile(book_chapter_parent_tasks);
...
const book_main_title_value = book_main_title.replaceAll(/\s/g, "_").toLowerCase();
...
2. [[50_33_proj_ed_book_parent_chapter|Education Book Project and Chapter Parent Tasks Template]]

#### In Conjunction

<!-- Snippets used together with this snippet  -->

1. [[50_32_proj_book_chapter_parent_tasks|50_32_proj_book_chapter_parent_tasks]]
...
1. [[50_21_habit_rit_month_proj_parent_tasks|Monthly Habits and Rituals Project Parent Tasks]]
2. [[51_21_parent_habit_rit_month]]
