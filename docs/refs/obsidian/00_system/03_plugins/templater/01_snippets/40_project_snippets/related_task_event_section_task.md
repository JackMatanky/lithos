---
title: related_task_event_section_task
aliases:
  - Related Tasks and Events Section for Task Files
  - Related Tasks and Events Section for Task Files Dataview Tables
  - related tasks and events section for task files dataview tables
  - related task event section task
plugin: templater
language:
  - javascript
module:
...
const related_task_section = `${new_line}${button}${outlink}${project}${parent}${child}${hr_line}${new_line}`;
...
1. [[100_42_related_task_sect_task_file]]
