...
aliases:
  - Advanced Cursors
  - obsidian_plugin_community_advanced_cursors
date_created: 2023-03-28T12:03
date_modified: 2023-09-05T19:17
tags: obsidian, obsidian/plugin, obsidian/advanced_cursors
---
# Advanced Cursors
...
Both `start` and `inc` can be arbitrary real numbers. The resulting number will be rounded to 4 decimals.
...
4. A toggle to say if the `query` should be interpreted as a regex or literal string.
