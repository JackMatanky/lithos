...
### [Elicitation Summary](../_bmad-output/planning-artifacts/analysis/elicitation_summary.md)
...
### [Project Brief](../_bmad-output/planning-artifacts/analysis/project_brief.md)
...
### [Change Log](../_bmad-output/planning-artifacts/architecture/change-log.md)

A log of changes and versions for the architecture document.

### [Checklist Results Report](../_bmad-output/planning-artifacts/architecture/checklist-results-report.md)
...
### [Core Workflows](../_bmad-output/planning-artifacts/architecture/core-workflows.md)

Diagrams and notes on the core user workflows for template generation, discovery, and vault indexing.

### [Data Model Relationships Diagram](../_bmad-output/planning-artifacts/architecture/data-model-relationships-diagram.md)
...
### [Error Handling Strategy](../_bmad-output/planning-artifacts/architecture/error-handling-strategy.md)

The strategy for error handling, including explicit results, error types, and logging standards.

### [External APIs](../_bmad-output/planning-artifacts/architecture/external-apis.md)

Information on external APIs that Lithos interacts with (none for MVP).

### [High Level Architecture](../_bmad-output/planning-artifacts/architecture/high-level-architecture.md)
...
### [Infrastructure and Deployment](../_bmad-output/planning-artifacts/architecture/infrastructure-and-deployment.md)

Details on the distribution strategy, infrastructure, environments, and deployment.

### [Next Steps](../_bmad-output/planning-artifacts/architecture/next-steps.md)

Next steps for the architecture and project.

### [REST API Spec](../_bmad-output/planning-artifacts/architecture/rest-api-spec.md)

Placeholder for a REST API specification for post-MVP.

### [Security](../_bmad-output/planning-artifacts/architecture/security.md)

Security considerations for input validation, authentication, secrets management, and data protection.

### [Source Tree](../_bmad-output/planning-artifacts/architecture/source-tree.md)

The layout of the source code repository.

### [Starter Template or Existing Project](../_bmad-output/planning-artifacts/architecture/starter-template-or-existing-project.md)
...
### [Testing Strategy](../_bmad-output/planning-artifacts/architecture/testing-strategy.md)
...
### [Epic 1: Foundational CLI & Static Template Engine](../_bmad-output/planning-artifacts/prd/epic-1-foundational-cli-static_template-engine.md)
...
### [Epic 2: Hexagonal Architecture Realignment](../_bmad-output/planning-artifacts/prd/epic-2-hexagonal-architecture-realignment.md)

This epic refactors the foundational CLI implementation from Epic 1 to follow hexagonal architecture patterns.

### [Epic 3: Configuration & Schema Loading](../_bmad-output/planning-artifacts/prd/epic-3-configuration-schema-loading.md)
...
### [Epic 4: Schema-Driven Lookups & Validation](../_bmad-output/planning-artifacts/prd/epic-4-schema-driven-lookups-validation.md)
...
### [Epic 5: Interactive Input Engine](../_bmad-output/planning-artifacts/prd/epic-5-interactive-input-engine.md)
...
### [Epic 6: Schema-Driven Lookups & Validation](../_bmad-output/planning-artifacts/prd/epic-6-schema-driven-lookups-validation.md)
...
### [Epic List](../_bmad-output/planning-artifacts/prd/epic-list.md)

A list of all the epics for the Lithos project.

### [Goals and Background Context](../_bmad-output/planning-artifacts/prd/goals-and-background-context.md)

The goals and background context for the Lithos project.

### [Index](../_bmad-output/planning-artifacts/prd/index.md)

The main index file for the Product Requirements Document.

### [Next Steps](../_bmad-output/planning-artifacts/prd/next-steps.md)

Next steps for the product.

### [Requirements](../_bmad-output/planning-artifacts/prd/requirements.md)

Functional and non-functional requirements for the Lithos project.

### [Technical Assumptions](../_bmad-output/planning-artifacts/prd/technical-assumptions.md)

Initial technical direction and library choices that will guide the architecture and implementation.

### [User Interface Design Goals](../_bmad-output/planning-artifacts/prd/user-interface-design-goals.md)
...
### [Story 1.1: Establish Test Vault and Golden Files](../_bmad-output/implementation-artifacts/stories/1.1.establish-test-vault-and-golden-files.md)
...
### [Story 1.2: Foundational Project Setup](../_bmad-output/implementation-artifacts/stories/1.2.foundational-project-setup.md)
...
### [Story 1.3: Implement a Runnable main.go and Basic CI Build](../_bmad-output/implementation-artifacts/stories/1.3.implement-runnable-main-and-ci.md)
...
### [Story 1.4: Integrate Cobra for Basic Command Structure](../_bmad-output/implementation-artifacts/stories/1.4.integrate-cobra-cli-framework.md)
...
### [Story 1.5: Add Placeholder new Command](../_bmad-output/implementation-artifacts/stories/1.5.add-placeholder-new-command.md)
...
### [Story 1.6: Implement Core Template File Reading](../_bmad-output/implementation-artifacts/stories/1.6.implement-template-file-reading.md)

As a developer, I want the new command to read a template file into memory, so that the content is available for parsing.

### [Story 1.7: Implement Static Template Parsing](../_bmad-output/implementation-artifacts/stories/1.7.implement-static_template-parsing.md)
...
### [Story 1.8: Add Basic Date & String Functions to Template Engine](../_bmad-output/implementation-artifacts/stories/1.8.add-template-functions.md)
...
### [Story 1.9: Write Rendered Template to a New File](../_bmad-output/implementation-artifacts/stories/1.9.write-rendered-template-to-file.md)
