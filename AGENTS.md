...
This project is indexed by GitNexus as **traces** (22218 symbols, 35562 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
