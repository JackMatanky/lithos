...
This project is indexed by GitNexus as **traces** (22152 symbols, 35397 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
