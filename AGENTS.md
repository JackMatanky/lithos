...
This project is indexed by GitNexus as **traces** (22320 symbols, 36055 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
