...
This project is indexed by GitNexus as **lithos** (19469 symbols, 25455 relationships, 296 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
