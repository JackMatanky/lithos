...
This project is indexed by GitNexus as **traces** (22749 symbols, 37021 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
