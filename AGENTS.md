...
This project is indexed by GitNexus as **traces** (22753 symbols, 37029 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
