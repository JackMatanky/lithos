...
This project is indexed by GitNexus as **lithos** (21043 symbols, 32442 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
