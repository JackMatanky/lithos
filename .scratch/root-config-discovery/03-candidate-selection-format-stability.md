...
This issue remains completed and now uses the standard completed/done tracker
metadata. Its predecessor blocker, `.scratch/root-config-discovery/02-local-candidate-generation.md`,
